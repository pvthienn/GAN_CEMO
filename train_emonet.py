...
def initParams():
    ...
    parser.add_argument("-i", "--in-path", type=str, help="Input folder containing", default='preprocessed_datase', required=None)
    # parser.add_argument("-v", "--val-path", type=str, help="Input folder containing validation data", default=None, required=True)
    parser.add_argument("-o", "--out-path", type=str, help="output folder", default='checkpoint', required=None)
    ...
    args.filters = [64, 128, 256, 256, 512, 512]
    #-----------------------------------------#
