...
parser.add_argument("--data_root", help="Root folder of the preprocessed LRS2 dataset", default='preprocessed_datase', required=None)

parser.add_argument('--checkpoint_dir', help='Save checkpoints to this directory', default='skpt_syncnet',required=None, type=str)
...
class Dataset(object):
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            x = (np.squeeze(x, axis=0).transpose(2, 0, 1) / 255)*2-1
            # print(x.shape)
            x = x[:, x.shape[1]//2:]
